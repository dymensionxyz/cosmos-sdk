...
// GroupPolicyMetadata represents structured metadata for a group policy
type GroupPolicyMetadata struct {
	// moniker is a human readable name for the group policy
	Moniker string `protobuf:"bytes,1,opt,name=moniker,proto3" json:"moniker,omitempty"`
	// description is a human readable description of the group policy
	Description string `protobuf:"bytes,2,opt,name=description,proto3" json:"description,omitempty"`
	// contact_details contains various contact information
	ContactDetails *GroupPolicyContactDetails `protobuf:"bytes,3,opt,name=contact_details,json=contactDetails,proto3" json:"contact_details,omitempty"`
	// fee_share is the percentage of fees shared with delegators
	FeeShare string `protobuf:"bytes,4,opt,name=fee_share,json=feeShare,proto3" json:"fee_share,omitempty"`
	// supported_rollapps is a list of rollapp IDs that this group policy supports
	SupportedRollapps []string `protobuf:"bytes,5,rep,name=supported_rollapps,json=supportedRollapps,proto3" json:"supported_rollapps,omitempty"`
}

func (m *GroupPolicyMetadata) Reset()         { *m = GroupPolicyMetadata{} }
func (m *GroupPolicyMetadata) String() string { return proto.CompactTextString(m) }
func (*GroupPolicyMetadata) ProtoMessage()    {}
func (*GroupPolicyMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_f5bddd15d7a54a9d, []int{7}
}
func (m *GroupPolicyMetadata) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GroupPolicyMetadata) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GroupPolicyMetadata.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GroupPolicyMetadata) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GroupPolicyMetadata.Merge(m, src)
}
func (m *GroupPolicyMetadata) XXX_Size() int {
	return m.Size()
}
func (m *GroupPolicyMetadata) XXX_DiscardUnknown() {
	xxx_messageInfo_GroupPolicyMetadata.DiscardUnknown(m)
}

var xxx_messageInfo_GroupPolicyMetadata proto.InternalMessageInfo

func (m *GroupPolicyMetadata) GetMoniker() string {
	if m != nil {
		return m.Moniker
	}
	return ""
...
func (m *GroupPolicyMetadata) GetDescription() string {
	if m != nil {
...
func (m *GroupPolicyMetadata) GetContactDetails() *GroupPolicyContactDetails {
	if m != nil {
...
func (m *GroupPolicyMetadata) GetFeeShare() string {
	if m != nil {
		return m.FeeShare
	}
	return ""
...
func (m *GroupPolicyMetadata) GetSupportedRollapps() []string {
	if m != nil {
		return m.SupportedRollapps
	}
	return nil
}

// GroupPolicyContactDetails contains contact information for a group policy
type GroupPolicyContactDetails struct {
...
func (m *GroupPolicyContactDetails) Reset()         { *m = GroupPolicyContactDetails{} }
func (m *GroupPolicyContactDetails) String() string { return proto.CompactTextString(m) }
func (*GroupPolicyContactDetails) ProtoMessage()    {}
func (*GroupPolicyContactDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_f5bddd15d7a54a9d, []int{8}
}
func (m *GroupPolicyContactDetails) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GroupPolicyContactDetails) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GroupPolicyContactDetails.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GroupPolicyContactDetails) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GroupPolicyContactDetails.Merge(m, src)
}
func (m *GroupPolicyContactDetails) XXX_Size() int {
	return m.Size()
}
func (m *GroupPolicyContactDetails) XXX_DiscardUnknown() {
	xxx_messageInfo_GroupPolicyContactDetails.DiscardUnknown(m)
}

var xxx_messageInfo_GroupPolicyContactDetails proto.InternalMessageInfo

func (m *GroupPolicyContactDetails) GetX() string {
	if m != nil {
		return m.X
	}
	return ""
...
func (m *GroupPolicyContactDetails) GetWebsite() string {
	if m != nil {
		return m.Website
	}
	return ""
...
func (m *GroupPolicyContactDetails) GetTelegram() string {
	if m != nil {
		return m.Telegram
	}
	return ""
...
type GroupPolicyInfo struct {
	...
	// metadata is structured metadata for the group policy.
	Metadata *GroupPolicyMetadata `protobuf:"bytes,4,opt,name=metadata,proto3" json:"metadata,omitempty"`
...
func (*Vote) Descriptor() ([]byte, []int) {
	return fileDescriptor_f5bddd15d7a54a9d, []int{12}
}
...
func init() {
	...
	proto.RegisterType((*GroupPolicyMetadata)(nil), "cosmos.group.v1.GroupPolicyMetadata")
	proto.RegisterType((*GroupPolicyContactDetails)(nil), "cosmos.group.v1.GroupPolicyContactDetails")
...
var fileDescriptor_f5bddd15d7a54a9d = []byte{
	...
	,
}
...
func (m *GroupPolicyMetadata) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GroupPolicyMetadata) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GroupPolicyMetadata) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.SupportedRollapps) > 0 {
		for iNdEx := len(m.SupportedRollapps) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.SupportedRollapps[iNdEx])
			copy(dAtA[i:], m.SupportedRollapps[iNdEx])
			i = encodeVarintTypes(dAtA, i, uint64(len(m.SupportedRollapps[iNdEx])))
			i--
			dAtA[i] = 0x2a
		}
	}
	if len(m.FeeShare) > 0 {
		i -= len(m.FeeShare)
		copy(dAtA[i:], m.FeeShare)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.FeeShare)))
		i--
		dAtA[i] = 0x22
	}
...
func (m *GroupPolicyContactDetails) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GroupPolicyContactDetails) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GroupPolicyContactDetails) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Telegram) > 0 {
		...
		i = encodeVarintTypes(dAtA, i, uint64(len(m.Telegram)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Website) > 0 {
	...
	if len(m.X) > 0 {
		i -= len(m.X)
		copy(dAtA[i:], m.X)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.X)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Proposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n12, err12 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.VotingPeriodEnd, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(m.VotingPeriodEnd):])
	if err12 != nil {
		return 0, err12
	}
	i -= n12
...
func (m *GroupPolicyMetadata) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if len(m.SupportedRollapps) > 0 {
		for _, s := range m.SupportedRollapps {
			l = len(s)
			n += 1 + l + sovTypes(uint64(l))
		}
	}
...
func (m *GroupPolicyContactDetails) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GroupPolicyMetadata) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GroupPolicyMetadata: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GroupPolicyMetadata: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			...
			if m.ContactDetails == nil {
				m.ContactDetails = &GroupPolicyContactDetails{}
			}
		...
		case 4:
			...
			m.FeeShare = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SupportedRollapps", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SupportedRollapps = append(m.SupportedRollapps, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *GroupPolicyContactDetails) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GroupPolicyContactDetails: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GroupPolicyContactDetails: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *GroupPolicyInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.Metadata == nil {
				m.Metadata = &GroupPolicyMetadata{}
			}
